...
struct IngredientToAddDTO: Codable {
    var libelle: String
    var unite: String
    var prix_unitaire: Double
    var stock: Double
    ...
    init(libelle: String, unite: String, prix_unitaire: Double, stock: Double, allergene: Int, id_categorie: Int, id_categorie_allergene: Int?) {
        self.libelle = libelle
        self.unite = unite
        self.prix_unitaire = prix_unitaire
        self.stock = stock
